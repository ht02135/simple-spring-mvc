		...
		return {
			...
			*/
			...
			handleCustomerSuccess2: function(result) {
				console.log("=== handleCustomerSuccess2 BEGIN ================================");
				...
				if (customerObj) {
					ko.mapping.fromJS(customerObj.full_name, {}, this.customerFullName);
					ko.mapping.fromJS(customerObj, {}, this.customer);
				...
				console.log("=== handleCustomerSuccess2 END ================================");
			},

			handleCustomerSuccess: function(result) {
				console.log("==== handleCustomerSuccess BEGIN ===============================");
				...
				if (customerObj) {
					...
					this.customer().age(customerObj.age);
					this.customer().Hobby(customerObj.Hobby);
					this.customer().full_name(customerObj.full_name);
					this.customer().first_nick_name(customerObj.first_nick_name);
					this.customer().last_nick_name(customerObj.last_nick_name);
					this.customer().weird_hobby(customerObj.weird_hobby);
				}
				
				console.log("=== handleCustomerSuccess ENC ================================");
			},
